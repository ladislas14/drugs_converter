...
class ActiveSubstanceNameTranslator:
    ...
    def get_translations_from_french_name(self, name=None):
        self.process.crawl(INNSpider, language='french', substance=name)
        self.process.start()
...
translator = ActiveSubstanceNameTranslator()
print(translator.get_translations_from_french_name(name="paracétamol"))
